<template>
	<view style="background-color: #EFEFF4;">
		<view class="item">
			...
			<text class="input" type="text">{{tddate}}</text>
		</view>
		<view class="hourLine"></view>
		
		<view class="item">
			<text class="itemName">用餐日期:</text>
			<text class="input" type="text">{{ycdate}}</text>
		</view>
		<view class="hourLine"></view>
		
		<view class="item">
			<text class="itemName">申请部门:</text>
			<text class="input" type="text">{{department}}</text>
		</view>
		<view class="hourLine"></view>
		
		<view class="item">
			<text class="itemNamearea" >用餐事由*:</text>
			<text class="input" type="text">{{reason}}</text>
		</view>
		<view class="hourLine"></view>
		
		<view class="item">
			<text class="itemNamearea" >用餐人员*:</text>
			<text class="input" type="text">{{ycry}}</text>
		</view>
		<view class="hourLine"></view>
		
		<view class="item">
			<text class="itemNamearea" >就餐地点*:</text>
			<text class="input" type="text">{{eatAddress}}</text>
		</view>
		<view class="hourLine"></view>
		
		<view class="item">
			<text class="itemName">用餐标准*:</text>
			<text class="input" type="text">{{ycbz}}</text>
		</view>
		<view class="vText"></view>
		<view class="item">
			<text class="itemName" style="display: flex;justify-content: center;align-items: center;">部门经理:</text>
...
export default {
	...
	methods: {
		...
		UpData: function(e) {
			...
			myData.append('jcsj', that.ycdate);
			myData.append('jcsy', that.reason);
			
			myData.append('ycry', that.ycry);
			myData.append('jcdd', that.eatAddress);
			myData.append('ydbz', that.ycbz);
