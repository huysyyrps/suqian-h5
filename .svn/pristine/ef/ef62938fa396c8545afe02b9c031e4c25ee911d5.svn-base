					...
					<view class="list-box">
						...
						<view class="container_of_slide" v-for="(item,index) in list" :key="index">
							<view class="slide_list"  :style="{transform:'translate3d('+item.slide_x+'px, 0, 0)'}">
								<view class="list-right-info" :style="{width:Screen_width+'px'}" @click="getDetail(item)">
									...
									<view class="now-message-info" >
										...
										<view class="list-right2">
											<view class="mt-2">
												<text class="mr-2" style="color: #000000;">计划ID：</text>
												<text style="color: #000000;">10607</text>
											</view>
											<view class="mt-2">
											...
											<view class="mt-2">
												<text class="mr-2" >类别：</text>
												<text >甩站</text>
											</view>
											<view class="mt-2" style="width: 300upx;">
												<text class="mr-2" >明细：</text>
												<text>10607车 甩站 时间06:38:05 站点25河冰公园甩站</text>
											</view>
										</view>
										<view class="list-right3">
											<text  style="color:#FF0000; width: 140rpx;"> 待处理</text>
										</view>
