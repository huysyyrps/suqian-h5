	...
	export default {
		...
		methods: {
			...
			searchClick(e) {
				...
				// if (this.lineCode.length <= 0 && this.busCode.length <= 0 && this.driverName.length <= 0 ){
				// 	uni.showToast({
				// 		title:"请选择查询方式"
				// 	})
				// }else{
					...
					uni.navigateTo({
						url: "./CompletionOrPunctuality_Rate_Detail?comOrPunRateDic=" + JSON.stringify(comOrPunRateDic) 
