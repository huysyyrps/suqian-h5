<template>
	<view style="background-color: #EFEFF4;">
		<view class="item">
			...
			<input class="input" placeholder="请选择驾驶员" :value="person" type="button" />
		</view>
		<view class="hourLine"></view>
		<view class="item">
			<text class="itemName">工号:</text>
			<input class="input" placeholder="请输入工号" :value="person" type="button" />
		</view>
		<view class="hourLine"></view>
		<view class="item">
			<text class="itemName">补签日期:</text>
		...
		<view class="item">
			<text class="itemName">补签时间:</text>
			<picker class="itemValue" mode="time" @change="bindStartDateChange"><input class="input" placeholder="请选择补签时间" v-model="startDate" type="text" /></picker>
		</view>
		...
		<view class="item">
			...
			<input class="input" placeholder="请输入申请人" v-model="leaverDays" type="number" />
		</view>
		<view class="hourLine"></view>
	...
	methods: {
		...
		getFlowLine: function(e) {
			...
			resquestJSOB.sendGetRequestJson({
				...
				data: {
					defId: dataString.driverLeaverDefId
				},
