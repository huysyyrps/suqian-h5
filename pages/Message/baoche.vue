<template>
	...
	<view>
		...
		<view class="flex justify-between">
			<view class="p-2" style="width: 100%;">
				...
				<view class="mt-2">
					...
					<view class="mt-2">
						<text class="mr-2" style="color: #9D9589;">时间：</text>
						<text>0600</text>
					</view>
					<view class="mt-2">
						<text class="mr-2" style="color: #9D9589;">站点：</text>
						<text>高等师范学校</text>
					</view>
					<view class="mt-2">
						<text class="mr-2" style="color: #9D9589;">类型：</text>
						<text>请求包车</text>
					</view>
		...
		<cLabel title='意见' v-model='form.textarea' @handRight='handTextareaRight' :dataText='form.textarea' mode='textarea' rightIcon='cuIcon-close'    />
		<view class="ffoot">
			<button class="bg-blue" @tap="handSubmit">同意</button>
			<button class="bg-blue" @tap="handSubmit">不同意</button>
		</view>
