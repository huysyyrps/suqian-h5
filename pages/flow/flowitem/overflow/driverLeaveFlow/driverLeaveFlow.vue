<template>
	<view style="background-color: #EFEFF4;">
		<uni-nav-bar background-color="#007AFF" left-icon="back" color="#FFFFFF"  right-text="历史" title="驾驶员请假" @clickLeft="finish" @clickRight="getLeaveHistor"></uni-nav-bar>
		<view class="item">
...
export default {
	components: { uniSection, uniPopup, uniIcons, uniFab },
	data() {
		return {
			pattern: {
				color: '#7A7E83',
	...
	methods: {
		...
		getLeaveHistor:function(e){
			uni.navigateTo({
				url:"driverLeaverFlowHistory"
			})
		}
	}
};
