...
export default {
	...
	methods: {
		...
		UpData:function(e){
			...
			myData.append('sqsj', this.appleDate);
			myData.append('hysdd', this.homeAddress);
			myData.append('sysj', this.userDate);
			myData.append('hymc', this.mettingName);
			myData.append('chrs', this.number);
			myData.append('zxtrs', this.zxtNumber);
			myData.append('cs', this.mettingRequest);
			myData.append('hb', this.HB);
			myData.append('xk', this.XK);
