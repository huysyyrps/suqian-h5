		...
		<view v-if="mode != 'img' && mode != 'textarea'" :class="['c-'+size,disabled ? 'disabled':'']" class="cLabel" :style="flex ? 'display: flex;' : ''">
			...
			<view class="cLabel-mw" >
				<view class="cLabel-m text-cut" :style="{'text-align':align}">
					...
					<view v-if="mode == 'text'"  >
						<input :class="disabled ? 'disabledInp': ''" confirm-type="next"  placeholder-class="input-placeholder" type="text" @input='handInput' :disabled='disabled'   @blur="handBlur" v-model="inputValue"  :placeholder="placeholder? placeholder : '点击输入' " />
					</view>
					<view v-if="mode == 'number'"  >
						<input :class="disabled ? 'disabledInp': ''" confirm-type="next"  placeholder-class="input-placeholder" type="number" @input='handInput' :disabled='disabled' @blur="handBlur" v-model="inputValue" :placeholder="placeholder? placeholder : '点击输入' " />
					</view>
					<view v-if="mode == 'idcard'"  >
						<input :class="disabled ? 'disabledInp': ''" confirm-type="next" placeholder-class="input-placeholder"  type="idcard" @input='handInput' :disabled='disabled' @blur="handBlur" v-model="inputValue" :placeholder="placeholder? placeholder : '点击输入' " />
					</view>
					<view v-if="mode == 'password'"  >
						<input :class="disabled ? 'disabledInp': ''" confirm-type="next"  placeholder-class="input-placeholder" type="text" password @input='handInput' :disabled='disabled' @blur="handBlur" v-model="inputValue" :placeholder="placeholder? placeholder : '点击输入' " />
					</view>
					<!-- mode='switch' -->
